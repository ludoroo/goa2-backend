...
def test_contract_and_implementation_modules_have_explicit_homes() -> None:
    expected = (
        ...
        "automata.training.evaluate_artifact",
        "automata.training.evaluation",
    ...
    retired = (
        ...
        "automata.models.shared_encoder.legacy",
...
def test_training_and_evaluation_do_not_import_each_other() -> None:
    root = Path(__file__).parents[2] / "src" / "automata"
