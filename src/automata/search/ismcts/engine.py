...
class _Simulator:
    ...
    def __init__(
        ...
        *,
        ...
        self.state = state
        # Simulations preserve rollback boundary/control-flow semantics, but
        # their disposable sessions never serialize rollback snapshots.
        ...
        self.max_advance_steps = max_advance_steps
...
def _simulate(
    ...
    *,
    ...
    sim = _Simulator(
        ...
        deadline=deadline,
        max_advance_steps=cfg.max_advance_steps,
    )
